                ...
                <div class="inline-flex justify-center py-5 px-5">
                    <div class="rounded-lg shadow-lg bg-white max-w-sm">
                        ...
                        <div class="p-6">
                            ...
                            <button type="button" class=" inline-block px-6 py-2.5 bg-purple-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-purple-700 hover:shadow-lg focus:bg-purple-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-800 active:shadow-lg transition duration-150 ease-in-out" onClick={() => navigate('/pantry')}>View</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="inline-flex justify-center py-5 px-5">
                    <div class="rounded-lg shadow-lg bg-white max-w-sm">
                        ...
                        <div class="p-6">
                            ...
                            <button type="button" class=" inline-block px-6 py-2.5 bg-purple-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-purple-700 hover:shadow-lg focus:bg-purple-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-800 active:shadow-lg transition duration-150 ease-in-out" onClick={() => navigate('/gymnasium')}>View</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="inline-flex justify-center py-5 px-5">
                    <div class="rounded-lg shadow-lg bg-white max-w-sm">
                        ...
                        <div class="p-6">
                            ...
                            <button type="button" class="inline-block px-6 py-2.5 bg-purple-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-purple-700 hover:shadow-lg focus:bg-purple-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-800 active:shadow-lg transition duration-150 ease-in-out" onClick={() => navigate('/bicycle')}>View</button>
                        </div>
                    </div>
                </div>
            </div>
